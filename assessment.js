(function(){
    ...
    Button.onclick = () => {
        ...
        // 診断結果表示エリアの作成 ボタンを押されてから表示したいからjsにh3タグをクリエイトしている。
        removeAllChildren(resultDivided); //削除の関数ｓ 子要素を削除する
        ...
        img.src = 'yjimag2e.png'
        tweetDivided.appendChild(img);
    ...
    function assessment(userName) {
        ...
        console.assert(
            assessment('桝田') === assessment('桝田'),'ばーか。'
        );


        console.log(assessment('桝田'));
